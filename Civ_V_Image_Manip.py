...
#               pdf_c.stroke(hex_path, [color.rgb.black, style.linewidth(0.0)])
    ...
    def __init__(   self, infilename, mapsize, method,
        ...
        image_dims['sc3']['duel']       = [[771, 564, 1817, 946], 25.9024, 22.4321, 0.0, 0.75, 0, 24, 0,  40], # 24,  40 
        image_dims['sc3']['tiny']       = [[829, 564, 1701, 946], 17.3818, 15.0531, 0.0, 0.65, 0, 36, 0,  56], # 36,  56 
        image_dims['sc3']['small']      = [[821, 564, 1718, 946], 14.9156, 12.9173, 0.0, 0.65, 0, 42, 0,  66], # 42,  66 
        image_dims['sc3']['standard']   = [[839, 564, 1682, 946], 12.0634, 10.4472, 0.0, 0.65, 0, 52, 0,  80], # 52,  80 
        image_dims['sc3']['large']      = [[792, 564, 1776, 946],  9.8122,  8.4976, 0.0, 0.65, 0, 64, 0, 104], # 64, 104 
        image_dims['sc3']['huge']       = [[805, 564, 1750, 946],  7.8628,  6.8093, 0.0, 0.50, 0, 80, 0, 128], # 80, 128 
                                                                                                            
        image_dims['sc4sb']['duel']     = [[886, 678, 1817, 946], 25.9024, 22.4321, 0.0, 0.75, 0, 24, 0,  40], # 24,  40 
        image_dims['sc4sb']['tiny']     = [[944, 678, 1701, 946], 17.3818, 15.0531, 0.0, 0.65, 0, 36, 0,  56], # 36,  56 
        image_dims['sc4sb']['small']    = [[935, 678, 1718, 946], 14.9156, 12.9173, 0.0, 0.65, 0, 42, 0,  66], # 42,  66 
        image_dims['sc4sb']['standard'] = [[953, 678, 1682, 946], 12.0634, 10.4472, 0.0, 0.65, 0, 52, 0,  80], # 52,  80 
        image_dims['sc4sb']['large']    = [[906, 678, 1776, 946],  9.8122,  8.4976, 0.0, 0.65, 0, 64, 0, 104], # 64, 104 
        image_dims['sc4sb']['huge']     = [[919, 678, 1750, 946],  7.8628,  6.8093, 0.0, 0.50, 0, 80, 0, 128], # 80, 128 
